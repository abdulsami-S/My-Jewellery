...
// import { LogOut, Plus, Edit, Trash2, Eye, TrendingUp, Package, Mail, MessageSquare } from "lucide-react";
...
//     try {
//       const [analyticsRes, productsRes, enquiriesRes, testimonialsRes, ratesRes] = await Promise.all([
...
//     e.preventDefault();
//     try {
//       const response = await axios.post(`${API}/organizer/login`, { email, password });
...
//       setProductForm(prev => ({
//         ...prev,
//         images: [...prev.images, { url: imageInput, caption: imageCaption, is_cover: prev.images.length === 0 }]
//       }));
//       setImageInput("");
//       setImageCaption("");
//     }
...
//   if (!isLoggedIn) {
//     return (
//       <div className="min-h-screen bg-gradient-to-br from-amber-50 to-rose-50 flex items-center justify-center px-4" data-testid="login-screen">
//         <Card className="p-8 w-full max-w-md bg-white shadow-2xl">
//           <div className="text-center mb-6">
//             <h1 className="text-3xl font-bold mb-2">
//               <span className="gold-text">DGM</span> <span className="maroon-text">Organizer</span>
//             </h1>
...
//               />
//             </div>
//             <Button type="submit" className="btn-gold w-full py-6" data-testid="login-submit-btn">
//               Login
//             </Button>
//           </form>
...
//     return (
//       <div className="min-h-screen bg-gradient-to-br from-amber-50 to-rose-50 flex items-center justify-center px-4" data-testid="password-change-screen">
//         <Card className="p-8 w-full max-w-md bg-white shadow-2xl">
//           <h2 className="text-2xl font-bold mb-6 text-center">Change Password</h2>
//           <p className="text-gray-600 mb-6 text-center">Please change your password to continue</p>
...
//               />
//             </div>
//             <Button type="submit" className="btn-gold w-full py-6" data-testid="change-password-btn">
//               Change Password
//             </Button>
//           </form>
//         </Card>
...
//                 <span className="text-3xl font-bold gold-text">{analytics.total_products}</span>
//               </div>
...
//                 <span className="text-3xl font-bold text-blue-600">{analytics.total_enquiries}</span>
//               </div>
...
//                 <span className="text-3xl font-bold text-green-600">{analytics.pending_testimonials}</span>
//               </div>
...
//                 <span className="text-3xl font-bold text-purple-600">{analytics.bestsellers.length}</span>
//               </div>
...
//         {/* Tabs */}
//         <Tabs defaultValue="products" className="w-full" data-testid="dashboard-tabs">
...
//             <TabsTrigger value="enquiries" data-testid="enquiries-tab">Enquiries ({enquiries.length})</TabsTrigger>
//             <TabsTrigger value="testimonials" data-testid="testimonials-tab">Testimonials</TabsTrigger>
//           </TabsList>
...
//                     <Button className="btn-gold" onClick={resetProductForm} data-testid="add-product-btn">
...
//                           <Select value={productForm.metal_type} onValueChange={(value) => setProductForm({ ...productForm, metal_type: value })}>
...
//                           <Select value={productForm.purity} onValueChange={(value) => setProductForm({ ...productForm, purity: value })}>
...
//                       <Button type="submit" className="btn-gold w-full" data-testid="save-product-btn">
...
//                       <img
//                         src={product.images[0]?.url || "https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?w=100"}
//                         alt={product.name}
//                         className="w-16 h-16 object-cover rounded"
//                       />
//                       <div>
//                         <h3 className="font-semibold">{product.name}</h3>
//                         <p className="text-sm text-gray-600">{product.metal_type} {product.purity} • {product.weight}g</p>
//                         <p className="text-sm text-gray-500">{product.view_count} views</p>
//                       </div>
//                     </div>
//                     <div className="flex gap-2">
//                       <Button variant="outline" size="sm" onClick={() => openEditProduct(product)} data-testid={`edit-product-${product.id}`}>
//                         <Edit className="w-4 h-4" />
//                       </Button>
//                       <Button variant="outline" size="sm" onClick={() => handleDeleteProduct(product.id)} data-testid={`delete-product-${product.id}`}>
...
//               {metalRates && (
//                 <form onSubmit={handleUpdateRates} className="space-y-4 max-w-md">
//                   <div>
//                     <label className="block text-sm font-medium mb-2">Gold 22K (per gram)</label>
//                     <Input
//                       type="number"
//                       step="0.01"
//                       value={metalRates.gold_22k}
//                       onChange={(e) => setMetalRates({ ...metalRates, gold_22k: parseFloat(e.target.value) })}
//                       data-testid="gold-22k-input"
//                     />
//                   </div>
//                   <div>
//                     <label className="block text-sm font-medium mb-2">Gold 24K (per gram)</label>
//                     <Input
//                       type="number"
//                       step="0.01"
//                       value={metalRates.gold_24k}
//                       onChange={(e) => setMetalRates({ ...metalRates, gold_24k: parseFloat(e.target.value) })}
//                       data-testid="gold-24k-input"
//                     />
//                   </div>
//                   <div>
//                     <label className="block text-sm font-medium mb-2">Silver 999 (per gram)</label>
//                     <Input
//                       type="number"
//                       step="0.01"
//                       value={metalRates.silver_999}
//                       onChange={(e) => setMetalRates({ ...metalRates, silver_999: parseFloat(e.target.value) })}
//                       data-testid="silver-999-input"
//                     />
//                   </div>
//                   <div>
//                     <label className="block text-sm font-medium mb-2">Diamond (per carat)</label>
//                     <Input
//                       type="number"
//                       step="0.01"
//                       value={metalRates.diamond_per_carat}
//                       onChange={(e) => setMetalRates({ ...metalRates, diamond_per_carat: parseFloat(e.target.value) })}
//                       data-testid="diamond-input"
//                     />
//                   </div>
//                   <Button type="submit" className="btn-gold" data-testid="update-rates-btn">
//                     Update Rates
//                   </Button>
//                 </form>
//               )}
...
//                         <p className="text-sm text-gray-600">{testimonial.rating} ⭐ • {testimonial.product_type}</p>
//                       </div>
